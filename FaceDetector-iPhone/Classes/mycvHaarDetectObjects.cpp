...
CV_IMPL int
mycvRunHaarClassifierCascade( const CvHaarClassifierCascade* _cascade,
						   CvPoint pt, int start_stage )
{
	...
	int pq0 = cascade->pq0[pq_offset],pq1 = cascade->pq1[pq_offset],pq2 = cascade->pq2[pq_offset],pq3 = cascade->pq3[pq_offset];
