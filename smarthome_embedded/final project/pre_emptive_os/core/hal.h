...
#include "../core/_oshal/api/a7hal.h"
...
#define m_os_ctx_switch()                                 ctxSwitch_oshal()
#define m_os_isr_ctx_switch()                             ctxSwitchIsr_oshal()
#define m_os_start_high_proc()                            startHighProc_oshal()
#define m_os_stk_frame_init(proc, pStk, pParam, onReturn) stkFrameInit_oshal(proc, pStk, pParam, onReturn)
#define m_os_idle()                                       asm volatile (" nop")
#define m_os_init_hal()                                   initTimer_oshal()
